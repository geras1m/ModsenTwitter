import{u as n,m as i,e as y,d as oe,c as ne,l as J,j as t,P as se,i as u,S as re,s as ae,h as ie,F as le,a as de}from"./index-DUdeovaR.js";import{B as me,S as ce}from"./index-DEkkooFv.js";import{C as pe}from"./index-DuurqdaY.js";import{P as ge}from"./index-DUMPB9Vk.js";import{T as he}from"./index-pV2Itv8f.js";import{u as xe,E as f}from"./index.esm-VvRJ2cnM.js";import{n as A,t as ue,P as N,a as G}from"./validation-acDEGS74.js";import{F as k,a as H,E as fe}from"./index-C_Oo3Dte.js";import{a as we}from"./index-Ca9tUTrv.js";const c=3,p=25,be={name:{name:"name",placeholder:"Name",type:"text",minLength:`The minimum line length is ${c}`,maxLength:`The maximum line length is ${p}`,pattern:"The name should start with letters"},surname:{name:"surname",placeholder:"Surname",type:"text",minLength:`The minimum line length is ${c}`,maxLength:`The maximum line length is ${p}`,pattern:"The surname should start with letters"},telegramLink:{name:"telegramLink",placeholder:"Telegram nickname",type:"text",minLength:`The minimum line length is ${c}`,maxLength:`The maximum line length is ${p}`,pattern:"Telegram nickname should follow the pattern: @nick "},newPassword:{name:"newPassword",placeholder:"New password",pattern:"The password should be at least 6 symbols long and contain a digit"},currentPassword:{name:"currentPassword",placeholder:"Сurrent password",pattern:"The password should be at least 6 symbols long and contain a digit"}},$e=n.div`
  position: fixed;
  top: 0;
  bottom: 0;
  right: 0;
